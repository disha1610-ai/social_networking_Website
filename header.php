<?php
// Example 02: header.php
session_start();

// Note: I have replaced local links with CDNs so the app works immediately.
// If you want to work offline later, you will need to download these files.
echo <<<_INIT
<!DOCTYPE html> 
<html>
  <head>
...
// CHANGE 1: Title updated to Rudra Nest
echo <<<_MAIN
